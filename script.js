...
- [Disaster Recovery e Business Continuity](#disaster-recovery-business-continuity)
  ...
  - [DR Plan](#dr-plan---estrutura)
  - [Testes de DR](#testes-de-dr)
...
<h3 id="dr-plan---estrutura">DR Plan - Estrutura</h3>

#### Componentes de um DR Plan

**1. Inventário de Assets**
- Todos os sistemas críticos
- Aplicações e dependências
- Dados e volumes
- Priorização (Tier-0, Tier-1, Tier-2)
...
**4. Testing Schedule**
- Testes mensais/trimestrais
- Tipos de teste (desktop, partial, full)
- Métricas de sucesso

**5. Review and Update**
- Revisar após cada teste
- Atualizar após mudanças
- Versioning do documento

---

<h3 id="testes-de-dr">Testes de DR</h3>

#### Tipos de Teste

**1. Desktop Walkthrough**
- **O Que:** Revisão do plano em reunião
- **Frequência:** Mensal
- **Impacto:** Zero
- **Objetivo:** Familiarizar equipe

**2. Tabletop Exercise**
- **O Que:** Simulação em sala, sem tocar infra
- **Frequência:** Trimestral
- **Impacto:** Zero
- **Objetivo:** Testar tomada de decisão

**3. Partial Failover Test**
- **O Que:** Failover de **sistemas não-críticos**
- **Frequência:** Semestral
- **Impacto:** Baixo
- **Objetivo:** Validar procedimentos técnicos

**4. Full Failover Test**
- **O Que:** Failover **completo** para DR site
- **Frequência:** Anual
- **Impacto:** Possível interrupção breve
- **Objetivo:** Certificar que DR funciona 100%

**5. Surprise Drill**
- **O Que:** Teste **não anunciado** (sem aviso)
- **Frequência:** Raro
- **Impacto:** Alto (pode causar stress)
- **Objetivo:** Realismo máximo
